  ...
  return (
    <section className="site-section bg-background-elevated">
      <div className="site-container">
        ...
        <div className="mt-10 grid gap-5 sm:mt-12 sm:gap-7 md:mt-14 md:grid-cols-2 lg:grid-cols-3">
          {displayedPrograms.map((program, index) => (
            <FadeIn key={program.id} delay={index * 0.1}>
              ...
              >
                <div
                  className="h-46 bg-cover bg-center transition-transform duration-500 group-hover:scale-105 sm:h-52"
                ...
                <div className="relative flex flex-1 flex-col p-5 sm:p-6">
                  ...
                  <h3 className="mb-2 text-xl font-semibold sm:mb-3 sm:text-2xl">{program.title}</h3>
